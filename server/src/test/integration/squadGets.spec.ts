...
describe('INTEGRATION squad query gets', () => {
    it('Does the thing', async () => {
      ...
      createSquad(input: $input) {
        ...
        const memberOfSquadsResNoMember = await testClient.query({ query: getMemberOfSquadsNoMember });
        ...
        const memberOfSquadsRes = await testClient.query({ query: getMemberOfSquads });
